...
const styles = StyleSheet.create({
  ...
  modalCover: { width: '100%', aspectRatio: 1, borderRadius: 12, marginBottom: 14, backgroundColor: '#0F0F12' },
  ...
  modalPrice: { color: '#FF6B00', fontSize: 20, fontWeight: '800', marginBottom: 16 },
  modalSectionLabel: { color: '#737373', fontSize: 10, textTransform: 'uppercase', marginBottom: 8 },
  includedRow: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#0F0F12', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, marginBottom: 8 },
  includedRowText: { color: '#F5F5F7', fontSize: 12, fontWeight: '600', flex: 1 },
  chevron: { color: '#525252', fontSize: 18 },
  unlockButton: { flexDirection: 'row', gap: 8, backgroundColor: '#FF6B00', borderRadius: 12, paddingVertical: 14, alignItems: 'center', justifyContent: 'center', marginTop: 8 },
  unlockButtonText: { color: '#0F0F12', fontSize: 14, fontWeight: '800' },
  keyBox: { backgroundColor: '#0F0F12', borderRadius: 10, padding: 14, marginTop: 8 },
