...
const styles = StyleSheet.create({
  ...
  title: { color: '#F5F5F7', fontSize: 17, fontWeight: '700' },
  ...
  thumbPlaceholder: { width: 48, height: 48, borderRadius: 10, backgroundColor: '#0F0F12', alignItems: 'center', justifyContent: 'center' },
  thumbPlaceholderText: { color: '#FF6B00', fontSize: 18, fontWeight: '800' },
  exerciseNameRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  exerciseName: { color: '#F5F5F7', fontSize: 13, fontWeight: '600', flexShrink: 1 },
  ...
  previewButton: { width: 32, height: 32, borderRadius: 16, backgroundColor: 'rgba(255,107,0,0.12)', borderWidth: 1, borderColor: '#FF6B00', alignItems: 'center', justifyContent: 'center', marginRight: 10 },
  previewButtonText: { color: '#FF6B00', fontSize: 11, fontWeight: '800' },
  execucaoLink: { color: '#FF6B00', fontSize: 10, fontWeight: '700', marginTop: 4 },
  addIcon: { color: '#FF6B00', fontSize: 22, fontWeight: '800', paddingHorizontal: 4 },
